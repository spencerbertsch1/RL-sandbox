...
class WildFireEnv(gym.Env):
    ...
    def calculate_reward(self):
        ...
        if self.done:
            ...
            # define the reward for dropping phos chek in the right or wrong place
            phos_chek_reward = 0
            if self.phos_check_dump: 
                ...
                if (self.plane.previous_state not in [node.state for node in self.burning_nodes]) & \
                    ...
                    phos_chek_reward = -reward_offset/6
            ...
            self.reward: float = (reward_offset - fire_dist) + phos_chek_reward
