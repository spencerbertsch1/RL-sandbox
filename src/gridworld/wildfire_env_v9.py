...
class WildFireEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.FIRE_SPEED = 25  # <-- lower is faster
        ...
        if self.done:
            ...
            if self.phos_check_dump: 
                ...
                if lists_overlap(l1, l2):
                    ...
                    phos_chek_reward = 2 * reward_offset * (self.beta**self.total_timesteps)
...
"""
Create an exponentially increasing reward as the plane drops phos chek closer to the fire
"""