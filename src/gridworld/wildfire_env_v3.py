...
class WildFireEnv(gym.Env):
    ...
    def calculate_reward(self):
        ...
        Big reward for dropping phos chek in the right place, small rewards for dropping in the wrong place

        New final reward function based on penalty for trees burned
        """
        if self.done:
            ...
            self.reward = float(self.REWARD_BALANCER*self.reward - 10*((1-self.REWARD_BALANCER) * final_penalty))
